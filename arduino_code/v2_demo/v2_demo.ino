...
void loop()
{
  ...
  // DEMO: Changed amount of milliseconds in one minute
  if (overall >= (5000 * minutes_elapsed)) {
    minutes_elapsed += 1;
  ...
  // DEMO: Changed amount of index points needed for sunblock application
  // Check out https://pdskin.com/blogs/uv-index-the-sun-safety-scale
  if (time_since_last_buzz > 10) {
    buzz_on = true;
